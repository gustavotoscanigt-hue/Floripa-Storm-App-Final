...
export const VideoPlayer: React.FC<VideoPlayerProps> = ({
  ...
  useEffect(() => {
    ...
    // Initial resize after a short delay to ensure video loaded
  ...
  const handleStart = (e: React.MouseEvent | React.TouchEvent) => {
    // If active clip (zoomed), disable drawing
      ...
      >
        ...
        >
          <video
            ...
            playsInline
            muted={!!activeClip} // Mute if clip is playing (slowmo)
          />
          ...
          {/* Render Annotation Points (DOM elements for tooltips) */}
